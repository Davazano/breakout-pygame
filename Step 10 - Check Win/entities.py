...
class BrickSprites(pygame.sprite.Group):
    def __init__(self):
        super().__init__()
...
class Brick(pygame.sprite.Sprite):
    def __init__(self, groups, ball_sprite, pos):
        ...
        pygame.draw.rect(self.image, self.color, pygame.FRect((2,2), [self.width - 4, self.height - 4]), 0, 2)
        self.rect = self.image.get_frect(center = self.position)


    def check_collision(self):
        for sprite in self.ball_sprite:
